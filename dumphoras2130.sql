...
--
-- Name: recomendacao_refeicoes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.recomendacao_refeicoes (
    recomendacao_id integer NOT NULL,
...
--
-- Name: recomendacoes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: recomendacoes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.recomendacoes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: recomendacoes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.recomendacoes_id_seq OWNED BY public.recomendacoes.id;
...
--
-- Name: recomendacoes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recomendacoes ALTER COLUMN id SET DEFAULT nextval('public.recomendacoes_id_seq'::regclass);
...
--
-- Data for Name: recomendacao_refeicoes; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: recomendacoes; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.restricoes VALUES (3, 'Intolerância à lactose', 'Evita alimentos com lactose');
INSERT INTO public.restricoes VALUES (4, 'Intolerância ao glúten', 'Evita alimentos com glúten');
...
--
-- Name: recomendacoes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.recomendacoes_id_seq', 1, false);
...
--
-- Name: recomendacao_refeicoes recomendacao_refeicoes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recomendacao_refeicoes
    ADD CONSTRAINT recomendacao_refeicoes_pkey PRIMARY KEY (recomendacao_id, refeicao_id);


--
-- Name: recomendacoes recomendacoes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: avaliacoes avaliacoes_recomendacao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.avaliacoes
    ADD CONSTRAINT avaliacoes_recomendacao_id_fkey FOREIGN KEY (recomendacao_id) REFERENCES public.recomendacoes(id) ON DELETE CASCADE;
...
--
-- Name: recomendacao_refeicoes recomendacao_refeicoes_recomendacao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recomendacao_refeicoes
    ADD CONSTRAINT recomendacao_refeicoes_recomendacao_id_fkey FOREIGN KEY (recomendacao_id) REFERENCES public.recomendacoes(id) ON DELETE CASCADE;


--
-- Name: recomendacao_refeicoes recomendacao_refeicoes_refeicao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: recomendacoes recomendacoes_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
